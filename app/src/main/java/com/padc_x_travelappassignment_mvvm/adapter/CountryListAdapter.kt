...
import com.padc_x_travelappassignment_mvvm.views.viewholder.CountryViewHolder

class CountryListAdapter(delegate: TourItemsDelegate) : BaseRecyclerAdapter<BaseViewHolder<CountryVo>,CountryVo>() {
